...
\usepackage{colortbl}
\usepackage{color}
\usepackage{textcomp} % TODO: nur für Beispieltext in summary.tex genutzt, wird nicht benötigt

% Besondere Trennungen (z.B. bei vereinzelter Nutzung englischer Begriffe ohne Nutzung des multilingualen Supports von babel)
\hyphenation{Kon-fi-denz Kon-fi-denz-wert Mus-kel-ak-ti-vi-tät Bank-um-feld}
